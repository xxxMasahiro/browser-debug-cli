...
- [ ] Phase 29a: add `agent_execution` schema and document/security/schema parity without changing existing workflow or review schemas except additive references.
- [ ] Phase 29b: add CLI parser and package API surfaces for `agent execution plan/run/status/list`.
...
- [ ] Phase 29d: implement dry-run execution plans, local receipts, boundary flags, and dashboard next-command hints.
