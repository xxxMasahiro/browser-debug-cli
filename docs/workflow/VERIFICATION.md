...
- Browser smoke tests continue to prove enabled advisory output does not change review findings, `metrics.finding_count`, `action_plan`, or `quality_signals.release_readiness`.
